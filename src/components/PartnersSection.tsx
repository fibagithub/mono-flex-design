      ...
      <div className="relative">
        ...
        <div className="flex animate-marquee items-center">
          {doubled.map((partner, i) => {
            const langLogo = lang === "mn" ? partner.logo_url_mn : partner.logo_url_en;
            const otherLogo = lang === "mn" ? partner.logo_url_en : partner.logo_url_mn;
            const logo = langLogo || partner.logo_url || otherLogo;
            return (
