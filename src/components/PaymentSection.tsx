...
const content = {
  ...
  intro: {
    mn: "Манай аюулгүй, уян хатан төлбөрийн гарц нь бизнесүүдэд онлайн төлбөрийг карт, QPay болон бусад орчин үеийн төлбөрийн аргуудаар хүлээн авах боломжийг хялбар, найдвартайгаар олгодог. API интеграц, динамик токенжуулалт, 3D Secure v2.2, бодит цагийн гүйлгээний хяналт зэрэг дэвшилтэт технологиудыг дэмждэг. Мөн PayLink (www.paylink.mn) үйлчилгээгээр дамжуулан бизнесүүдэд URL линк, SMS, эсвэл имэйл-ээр аюулгүй төлбөрийн нэхэмжлэх илгээж хялбар аргаар төлбөр цуглуулахад төгс шийдэл юм.",
    en: "Our secure and flexible payment gateway enables businesses to easily and reliably accept online payments through cards, QPay, and other modern payment methods. The platform supports advanced technologies including seamless API integration, dynamic tokenization, 3D Secure v2.2 authentication, and real-time transaction monitoring. In addition, through our PayLink (www.paylink.mn) service, businesses can conveniently collect payments by sending secure payment requests via URL links, SMS, or email, providing a simple and efficient way to receive payments from customers.",
  },
  modes: [
    {
