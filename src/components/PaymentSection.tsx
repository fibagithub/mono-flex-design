...
const content = {
  ...
  intro: {
    mn: "Манай аюулгүй, уян хатан төлбөрийн гарц нь бизнесүүдэд онлайн төлбөрийг карт, QPay болон бусад орчин үеийн төлбөрийн аргуудаар хүлээн авах боломжийг хялбар, найдвартайгаар олгодог. API интеграц, динамик токенжуулалт, 3D Secure v2.2, бодит цагийн гүйлгээний хяналт зэрэг дэвшилтэт технологиудыг дэмждэг.",
  ...
  localMethods: {
    mn: "Дотоодын аргууд: SocialPay, MonPay болон бусад. Олон улсын аргууд: Visa, Mastercard, UnionPay, WeChat Pay, Alipay.",
